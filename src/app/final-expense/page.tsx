...
export const metadata: Metadata = {
  title: 'Final Expense Insurance - End-of-Life Coverage | El-Mag Insurance',
  description: 'Get final expense insurance to cover end-of-life expenses and funeral costs. Protect your family from financial burden with affordable coverage.',
  keywords: 'final expense insurance, funeral insurance, burial insurance, end of life expenses, funeral costs coverage',
};
      ...
      <section className="bg-gradient-to-r from-blue-600 to-blue-800 text-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl md:text-2xl mb-8 max-w-3xl mx-auto">
            Protect your family from the financial burden of end-of-life expenses with affordable final expense insurance coverage.
          </p>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-6">
                Final expense insurance is a type of life insurance designed to cover the costs associated with end-of-life expenses, including funeral costs, burial expenses, medical bills, and other final arrangements.
              </p>
              <p className="text-lg text-gray-600 mb-6">
                This coverage provides peace of mind knowing that your family won't face financial hardship during an already difficult time. It's typically easier to qualify for than traditional life insurance and offers smaller death benefits.
              </p>
