  ...
  const structuredData = {
    ...
    '@graph': [
      ...
      },
      {
        ...
        hasOfferCatalog: {
          '@type': 'OfferCatalog',
          name: 'Los Angeles County Medicare Supplement Plans',
          itemListElement: [
            {
              '@type': 'Offer',
              itemOffered: {
                ...
                description: 'Most popular LA County Medigap plan with comprehensive coverage and California community rating'
              }
            },
            {
              '@type': 'Offer',
              itemOffered: {
                ...
                description: 'Affordable LA County Medigap option with lower premiums and modest copayments'
              }
            },
            {
              '@type': 'Offer',
              itemOffered: {
                ...
                description: 'Budget-friendly LA County option for lower monthly premiums with higher deductible'
              }
            }
          ]
        }
      },
      {
        ...
        mainEntity: [
          {
            '@type': 'Question',
            name: 'What is California community rating for Medicare Supplement?',
            acceptedAnswer: {
              '@type': 'Answer',
              text: 'California uses community rating for Medicare Supplement plans, meaning premiums are the same for everyone regardless of age. This benefits older seniors who would otherwise pay higher premiums in attained-age or issue-age rating states. In Los Angeles County, a 65-year-old and an 85-year-old pay the same premium for the same Medigap plan from the same carrier.'
            }
          },
          {
            '@type': 'Question',
            name: 'How much does Medicare Supplement cost in Los Angeles County?',
            acceptedAnswer: {
              '@type': 'Answer',
              text: 'Medicare Supplement premiums in Los Angeles County vary by carrier and plan. Plan G typically ranges from $150-$250/month, Plan N from $120-$180/month, and High-Deductible Plan G from $50-$80/month. California\'s community rating means premiums don\'t increase with age, making LA County an excellent market for Medigap coverage. Comparing multiple carriers is essential as the same plan can vary $50-100/month between insurers.'
            }
          },
          {
            '@type': 'Question',
            name: 'Which hospitals accept Medicare Supplement in Los Angeles?',
            acceptedAnswer: {
              '@type': 'Answer',
              text: 'Medicare Supplement plans work at any hospital or medical facility in Los Angeles County that accepts Original Medicare, including Cedars-Sinai Medical Center, UCLA Medical Center, USC Keck Medicine, Providence hospitals, Kaiser Permanente (when accepting Medicare patients), and all other Medicare-participating providers. Unlike Medicare Advantage, there are no network restrictions with Medigap plans.'
            }
          },
          {
            '@type': 'Question',
            name: 'When can I enroll in Medicare Supplement in LA County?',
            acceptedAnswer: {
              '@type': 'Answer',
              text: 'The best time to enroll in Medicare Supplement in Los Angeles County is during your 6-month Medigap Open Enrollment Period starting when you turn 65 and enroll in Part B. During this period, you have guaranteed issue rights regardless of health conditions. You can also enroll year-round, but may face medical underwriting outside guaranteed issue periods. California offers additional protections including an annual birthday month enrollment period.'
            }
          },
          {
            '@type': 'Question',
            name: 'Why is Medicare Supplement penetration low in LA County?',
            acceptedAnswer: {
              '@type': 'Answer',
              text: 'Only 25% of Los Angeles County\'s 1.8 million Medicare beneficiaries have Medigap coverage, leaving 1.35 million without gap protection. Factors include aggressive Medicare Advantage marketing emphasizing "$0 premium" plans, confusion about California\'s community rating advantage, lack of awareness about comprehensive coverage benefits, and the region\'s extensive MA provider networks. However, for many LA County seniors, Medigap offers superior long-term value with predictable costs and unlimited provider access.'
            }
          }
        ]
      }
